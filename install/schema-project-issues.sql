-- Project metadata issues (manual + assessment-generated).
-- Fresh installs: included in install/schema.mysql.sql
-- Upgrades (table missing): migration 20260703000001_upgrade_v1_3_0.php
-- Upgrades (table exists): install/schema-project-issues-alter.sql
