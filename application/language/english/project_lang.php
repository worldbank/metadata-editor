...
$lang['duplicate_project']="Duplicate project";
$lang['duplicate_project_help']="A new editable copy will be created. Project history is not copied.";
$lang['project_duplicated_successfully']="Project duplicated successfully.";
...
$lang['delete_all_nada_resources_before_publish']="Remove all existing resources from the catalog";
$lang['delete_all_nada_resources_warning']="Removes all external resources for this study in the catalog. This cannot be undone.";
$lang['confirm_delete_all_nada_resources']="Remove all external resources for this study in the catalog? This cannot be undone.";
$lang['deleting_all_nada_resources']="Removing existing resources from the catalog…";
$lang['nada_resources_deleted_successfully']="Existing resources from the catalog removed";
...
$lang['indicator_publish_status']="Indicator data & structure";
$lang['indicator_publish_status_note']="DSD binding and observation data readiness on NADA";
$lang['indicator_publish_options']="Indicator options";
$lang['publish_dsd_to_nada']="Publish data structure (DSD)";
$lang['dsd_overwrite_on_nada']="Overwrite DSD if already exists";
$lang['publish_indicator_data_to_nada']="Publish indicator data";
$lang['publish_indicator_data_step_note']="Exports CSV from DuckDB, uploads to NADA in chunks, then imports observations.";
$lang['exporting_indicator_csv']="Exporting indicator data to CSV";
$lang['uploading_indicator_csv_to_nada']="Uploading CSV to NADA";
$lang['no_dsd_bound_to_project']="No data structure is bound to this project. Bind a DSD before publishing.";
$lang['no_published_indicator_data']="No published indicator data in DuckDB. Import data in the editor first.";
$lang['nada_dsd_exists']="DSD already exists on NADA";
$lang['nada_dsd_not_found']="DSD not found on NADA (will be created on publish)";
$lang['nada_dsd_matches_local']="matches local version";
$lang['nada_dsd_differs_from_local']="differs from local version";
$lang['nada_observation_count']="Observations on NADA";
$lang['rows_in_duckdb']="rows in DuckDB";
$lang['publishing_dsd_to_nada']="Publishing data structure to NADA";
$lang['publishing_indicator_data_to_nada']="Publishing indicator data to NADA";
$lang['dsd_published_successfully']="Data structure published to NADA successfully";
$lang['dsd_skipped_already_exists']="DSD already exists on NADA — skipped (enable overwrite to replace)";
$lang['indicator_data_published_successfully']="Indicator data published to NADA successfully";
$lang['publishing_via_background_job']="Publishing via background job";
$lang['background_job_failed']="Background publish job failed";
$lang['study_idno']="Study IDNO";
$lang['publish_study_idno_note']="Catalog identifier used when publishing to NADA";
$lang['publish_study_idno_missing']="Study IDNO is not set. Set it in project metadata before publishing.";
$lang['indicator_publish_order_note']="Recommended order: publish project metadata first (creates the study on NADA), then DSD, then indicator data.";
$lang['indicator_data_requires_metadata']="Publish project metadata first, or ensure the study already exists on the selected catalog.";
$lang['publish_save_before_confirm']="You have unsaved metadata changes. Save the project before publishing to NADA?";
$lang['publish_save_before_failed']="Could not save project metadata before publishing.";
$lang['publish_update_status']="Publish progress";
$lang['publish_export_failed']="Project export failed";
...
$lang['publish_export_step']="Prepare export files";
$lang['publish_completed_refreshing']="Refreshing catalog status";
$lang['publish_cancelled']="Publishing was cancelled.";
$lang['cancelling_publish']="Cancelling…";
...
$lang['confirm_delete_data']="Are you sure you want to delete all data from this file?";
...
$lang['generate_microdata_resource'] = "Generate microdata resource";
$lang['microdata_generate_page_description'] = "Create a publishable microdata file from your project data.";
$lang['microdata_zip_single_recommended'] = "Zip exported file (recommended)";
$lang['regenerate_microdata_resource'] = "Regenerate microdata resource";
$lang['microdata_resources'] = "Microdata resources";
$lang['other_external_resources'] = "Other external resources";
$lang['microdata_related_data_files'] = "Related data files";
$lang['microdata_related_data_files_hint'] = "Optional. Links this resource to editor data files for publish status tracking.";
$lang['microdata_no_data_files'] = "No data files in this project.";
$lang['microdata_select_at_least_one_file'] = "Select at least one data file.";
$lang['microdata_all_data_files'] = "Include all data files";
$lang['microdata_data_files'] = "Data files";
$lang['microdata_details'] = "Microdata details";
$lang['microdata_no_linked_files'] = "No related data files are linked to this resource.";
$lang['manual'] = "Manual";
$lang['link_type'] = "Link";
$lang['link_type_generated'] = "Generated";
$lang['link_type_manual'] = "Manual";
$lang['link_type_associated'] = "Associated";
$lang['bundle_type_zip'] = "ZIP";
$lang['bundle_type_single'] = "Single file";
$lang['zip_entry'] = "ZIP entry";
$lang['generated_at'] = "Generated";
$lang['microdata_overwrite_existing'] = "Replace existing resource for this format";
$lang['microdata_refresh_description'] = "Refresh description from data files";
$lang['microdata_generating'] = "Exporting data files and creating resource…";
$lang['microdata_generate_wait'] = "This may take several minutes.";
$lang['microdata_generate_success'] = "Microdata resource created successfully.";
$lang['microdata_resource_exists'] = "A generated microdata resource already exists for this format.";
$lang['microdata_resource_exists_hint'] = "A generated microdata resource already exists for this format. Select another format, or check Replace existing resource for this format.";
$lang['microdata_resource_exists_action'] = "Select another format, or check Replace existing resource for this format.";
$lang['view_existing_resource'] = "View existing resource";
$lang['microdata_resources_empty_hint'] = "No microdata resources yet. Generate one from your project data files.";
$lang['microdata_resources_no_data_files_hint'] = "Import project data files before you can generate a microdata resource.";
$lang['microdata_publish_empty_hint'] = "No microdata resources to publish. Generate one from your project data files before publishing to NADA.";
$lang['microdata_status_current'] = "Current";
$lang['microdata_status_stale'] = "Stale";
$lang['microdata_status_missing_file'] = "Missing file";
$lang['generated_microdata_resource'] = "Generated microdata resource";
$lang['manual_microdata_resource'] = "Manual microdata resource";
$lang['microdata_package_generated'] = "Microdata package";
$lang['microdata_section_manual'] = "Microdata";
$lang['microdata_publishable_file'] = "Publishable file";
$lang['microdata_included_data_files'] = "Data files included";
$lang['microdata_generated_readonly_hint'] = "File and export links are managed via Regenerate.";
$lang['microdata_links_save_failed'] = "Resource saved but data file links could not be saved.";
$lang['regenerate'] = "Regenerate";
$lang['generate'] = "Generate";
$lang['generated'] = "Generated";
$lang['bundle_type'] = "Bundle";
$lang['view_resource'] = "View resource";
