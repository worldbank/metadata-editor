<div v-if="!ActiveNode.key" class="m-3 p-3">Click on an item on sidebar to start editing!</div>
          ...
          <div v-if="ActiveNode.key">
            ...
            <div class="form-group" v-if="ActiveNode.key">
              <label for="original_description">Custom description:</label>
              <textarea style="height:200px;" class="form-control" id="original_description" v-model="ActiveNode.help_text"></textarea>
            </div>
