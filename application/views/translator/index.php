...
<td>
	...
	<?php foreach($this->master_lang as $key=>$value):?>
        ...
        <td>
			...
			<textarea name="<?php echo nada_hash($key);?>" class="flex-textarea flex" rows="<?php echo $lines;?>"><?php echo set_value(NULL, htmlspecialchars_decode($slave_value)); ?></textarea>
        </td>
        </tr>
        <?php //break;?>
    <?php endforeach;?>
