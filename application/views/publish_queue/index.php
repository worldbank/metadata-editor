...
<head>
  ...
  <style>
    ...
    .publish-queue-page tbody tr { cursor: pointer; }
    .publish-queue-page tbody tr:hover { background: rgba(82, 107, 199, .1) !important; }
    .publish-queue-page .publish-queue-history-table tbody tr { cursor: pointer; }
    .publish-queue-page .publish-queue-history-table tbody tr:hover { background: rgba(82, 107, 199, .1) !important; }
    .history-event-table tbody tr { cursor: pointer; }
    .history-event-table tbody tr:hover { background: rgba(82, 107, 199, .08) !important; }
  </style>
</head>
...
?>
        ...
        <div class="content-wrapperx" v-cloak>
          <section class="content">
            <div class="container-fluid">
              <div class="row">
                <div class="col-12">
                  <vue-publish-queue-component></vue-publish-queue-component>
                </div>
              </div>
            </div>
          </section>
  ...
  <script>
    ...
    echo $this->load->view("publish_queue/vue-publish-queue-component.js", null, true);
    ?>
  </script>
